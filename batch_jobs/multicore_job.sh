...
SAMPLE_PATH=""
SCAN_PATH="Larch_A_bin1x1_LFOV_80kV_7W_air_2p5s_6p6mu_bin1_recon.txm"
OUT_NAME="Larch_A_LFOV_pos1"

python -u preprocess.py --sample_path "$SAMPLE_PATH" --scan_path "$SCAN_PATH" --out_name "$OUT_NAME" --run_type "DTU_HPC" \
--min_size 1980 800 800 --max_size 1980 800 800 --margin_percent 0.5 --divis_factor 2 \
--save_downscaled 0 --f 4

SAMPLE_PATH=""
SCAN_PATH="Larch_A_bin1x1_4X_80kV_7W_air_1p5_1p67mu_bin1_pos1_recon.txm"
OUT_NAME="Larch_A_4x_pos1"

python -u preprocess.py --sample_path "$SAMPLE_PATH" --scan_path "$SCAN_PATH" --out_name "$OUT_NAME" --run_type "DTU_HPC" \
--min_size 2000 1900 1900 --max_size 2000 1900 1900 --margin_percent 0 --divis_factor 4 \
--save_downscaled 1 --f 1 --mask_threshold "otsu"
